// /about-bite/secretary-generals-message/page.jsx
import Banner from "@/components/Banner";
import Image from "next/image";
import React from "react";

const secretaryGeneralMessagePage = () => {
  return (
    <div>
      <Banner
        backgroundImage="/slider2.jpg"
        title="Secretary Genaral's Message"
        subtitle="Home | Secretary Genaral's Message"
      />
...
<div className="container mx-auto py-14 px-4 flex flex-col gap-8 ">
        ...
        />
          ...
          <div className="flex flex-col gap-1 text-end">
            <p className="font-semibold">Zakir Uddin Ahmed</p>
            <p className="font-semibold">Secretary General</p>
...
export default secretaryGeneralMessagePage;
